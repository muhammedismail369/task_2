...
class TestPlanTable extends StatefulWidget {
  final List<DataColumn> columns;
  final List<DataRow> rows;

  TestPlanTable({required this.columns, required this.rows});

  @override
  _TestPlanTableState createState() => _TestPlanTableState();
}

class _TestPlanTableState extends State<TestPlanTable> {
